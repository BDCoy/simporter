...
export default function HeaderLayout() {
  ...
  const mockUserData = {
    ...
    recentAchievements: [
      ...
      { id: 2, title: "3-Day Streak", completed: true },
      { id: 3, title: "Complete 10 Projects", completed: false, progress: 3 },
    ],
  };

  const progressPercentage =
    (mockUserData.currentXP / mockUserData.xpForNextLevel) * 100;
  ...
  const handleProfileAction = (
    action: "knowledge" | "billing" | "settings" | "logout"
  ) => {
    setShowProfileDropdown(false);
    switch (action) {
      case "knowledge":
          ...
          >
            ...
            <div className="hidden md:block">
              ...
              <div className="text-xs text-gray-500 mt-0.5">
                {mockUserData.currentXP}/{mockUserData.xpForNextLevel} XP
              </div>
            </div>
          </button>
