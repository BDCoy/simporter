...
export function HomePage() {
  ...
  const [activeTemplate, setActiveTemplate] = useState<
    (typeof quickStartTemplates)[0] | null
  >(null);
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const project = await createProjectFromSearch(
        searchQuery.trim(),
        aiDiscoveryEnabled,
        user.id
      );
    ...
    <div className="max-w-5xl mx-auto">
      <div className="text-center mb-12 mt-10">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-xl font-sf-pro">
          Generate insights, reports, and recommendations for consumer goods
          innovation.
        </p>
      </div>
          ...
          <div className="relative">
            <input
              ...
              placeholder={
                ...
                'Type "/" for commands or enter your question...'
              }
              className={cn(
              ...
              style={{
                caretColor:
                  activeTemplate?.color.replace("text-", "") || "currentColor",
              }}
            />
          ...
          {showCommands && (
            <div className="absolute left-0 right-0 top-full mt-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
              {quickStartTemplates.map((template, index) => (
                ...
                >
                  <template.icon
                    className={cn("w-4 h-4 mr-3", template.color)}
                  />
